...
export default function SubmitCafePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 py-16 px-8">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="openingHours" className="mb-2">Opening Hours (24hr format) *</Label>
                    <Input id="openingHours" name="openingHours" type="time" required />
                  </div>
                  <div>
                    <Label htmlFor="closingHours" className="mb-2">Closing Hours (24hr format) *</Label>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Label className="mb-2">Purpose (choose up to 2)</Label>
                ...
                <div>
                  <Label className="mb-2">Ambience Type (choose up to 3)</Label>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
                ...
                <div>
                  <Label className="mb-2">Amenities (choose any)</Label>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Label className="mb-2">Type of Food & Drinks *</Label>
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mt-4">
                ...
                {/* Menu Builder */}
                <div id="menu-builder" className="border rounded-lg p-6 space-y-6 bg-slate-50">
                  ...
                  {currentSection.items.map((item, index) => (
                    <div key={index} className="border rounded p-4 space-y-3 bg-white">
                  ...
                  <div className="flex gap-4">
                    <Button type="button" onClick={addMenuItem} variant="outline" className="flex-1 py-3">
                      <Plus className="h-4 w-4 mr-2" />
                      Add Dish
                    </Button>
                    <Button type="button" onClick={addOrUpdateSection} className="flex-1 py-3">
                      {editingSectionIndex !== null ? (
                        <>
                ...
                {menuSections.length > 0 && (
                  <div className="border rounded-lg p-6 bg-green-50">
                    <h4 className="font-semibold mb-4">Added Sections:</h4>
                    <div className="space-y-4">
                      {menuSections.map((section, idx) => (
                        <div key={idx} className="flex items-center justify-between bg-white p-4 rounded border">
                          <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="bestDish1" className="text-xs text-muted-foreground mb-2">Best Dish #1</Label>
                    ...
                    <div>
                      <Label htmlFor="bestDish2" className="text-xs text-muted-foreground mb-2">Best Dish #2</Label>
                    ...
                    <div>
                      <Label htmlFor="bestDish3" className="text-xs text-muted-foreground mb-2">Best Dish #3</Label>
                ...
                <div>
                  <Label htmlFor="menuFile" className="mb-2">Upload Menu File (Excel/PDF, optional)</Label>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <Label htmlFor="coverImage" className="mb-2">Cover Image (for café card) *</Label>
                  <Input id="coverImage" name="coverImage" type="file" accept="image/*" required />
                </div>

                <div>
                  <Label htmlFor="photos" className="mb-2">Upload 4-5 Café Photos (ambience/food) *</Label>
                  <Input id="photos" name="photos" type="file" accept="image/*" multiple required />
                  <p className="text-xs text-muted-foreground mt-2">Select 4-5 images</p>
                </div>
