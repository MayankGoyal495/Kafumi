...
export function VegMark({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="3" ry="3" fill="#1db954"/>
      <circle cx="12" cy="12" r="6" fill="#ffffff"/>
    </svg>
  )
}

export function NonVegMark({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="3" ry="3" fill="#dc2626"/>
      <circle cx="12" cy="12" r="6" fill="#ffffff"/>
    </svg>
  )
}
...
export function EggMark({ className = "" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <rect x="3" y="3" width="18" height="18" rx="3" ry="3" fill="#f59e0b"/>
      <circle cx="12" cy="12" r="6" fill="#ffffff"/>
    </svg>
  )
}
